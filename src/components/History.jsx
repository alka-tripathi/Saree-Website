    ...
    <div>
      <div>
        <Box sx={{ px: 2, py: 4, maxWidth: 1000, mx: 'auto' }}>
          ...
          >
            The saree is more than just an outfit — it's a symbol of India's
            rich cultural heritage, craftsmanship, and evolution through
            centuries.
          </Typography>
              ...
              <TimelineContent>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography color="text.secondary">
                      References in the Rig Veda to garments like Nivi and
                      Uttariya.
                    </Typography>
                  </Box>
                </Paper>
              ...
              <TimelineContent>
                ...
                >
                  ...
                  <Box>
                    ...
                    <Typography color="text.secondary">
                      Luxurious silks, brocades, and zari elevated sarees into
                      royal fashion.
                    </Typography>
                  </Box>
                </Paper>
